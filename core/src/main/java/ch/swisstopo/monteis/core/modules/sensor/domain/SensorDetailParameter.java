...
public class SensorDetailParameter {
  ...
  private SensorParameterReading sensorParameterReading;
  ...
  public SensorDetailParameter(
      ...
      Boolean active,
      String comment,
      SensorParameterReading sensorParameterReading) {
    this.name = name;
    ...
    this.sensorParameterReading = sensorParameterReading;
  }
  ...
  public SensorParameterReading getSensorParameterReading() {
    return sensorParameterReading;
  }

  public void setSensorParameterReading(SensorParameterReading sensorParameterReading) {
    this.sensorParameterReading = sensorParameterReading;
  }
}
