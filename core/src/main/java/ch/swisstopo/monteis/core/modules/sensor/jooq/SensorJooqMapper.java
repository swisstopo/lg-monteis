...
public interface SensorJooqMapper {
  ...
  @Mapping(target = "alarmLimits.lower", source = "sensorRecord.lowerAlarmBound")
  @Mapping(target = "alarmLimits.upper", source = "sensorRecord.upperAlarmBound")
  ...
  @Mapping(target = "lowerAlarmBound", source = "alarmLimits.lower")
  @Mapping(target = "upperAlarmBound", source = "alarmLimits.upper")
