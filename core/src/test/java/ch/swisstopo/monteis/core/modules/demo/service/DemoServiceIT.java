...
class DemoServiceIT {
  ...
  void should_prevent_audit_log_on_optimistic_locking_failure() {
    ...
    var initialDto = new WriteSensorDto(null, "sensor-lock-test", 100.0, 0.0, null, "x * 2", null);
  ...
  void should_audit_successful_insert_and_update() {
    ...
    var initialDto = new WriteSensorDto(null, "sensor-happy-path", 100.0, 0.0, null, "x * 2", null);
  ...
  void should_ignore_ghost_updates() {
    ...
    var initialDto = new WriteSensorDto(null, "sensor-ghost-test", 100.0, 0.0, null, "x * 2", null);
    var savedSensor = demoService.saveOrUpdateSensor(initialDto);
