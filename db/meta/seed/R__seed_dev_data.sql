...
-- IDs will be auto-generated by the DEFAULT uuidv7() constraint.
...
VALUES
    -- Param for TEMP-1
    ('00000000-0000-7000-8000-000000000201', 'Temperature Param', 'TEMP-1-P1', '00000000-0000-7000-8000-000000000101', 'KELVIN',
     '00000000-0000-7000-8000-000000000001', 100.0, -50.0, true, 'Primary temperature reading'),

    -- Param for PRESS-1&2
    ('00000000-0000-7000-8000-000000000202', 'Pressure Param', 'PRESS-1&2-P1', '00000000-0000-7000-8000-000000000102', 'KILOGRAM',
     '00000000-0000-7000-8000-000000000002', 5000.0, 0.0, true, 'Primary pressure reading'),

    -- Param for DISP-2
    ('00000000-0000-7000-8000-000000000203', 'Displacement Param', 'DISP-2-P1', '00000000-0000-7000-8000-000000000103', 'METER',
     '00000000-0000-7000-8000-000000000003', 50.0, -50.0, true, 'Primary displacement reading'),

    -- Param for FLOW-2
    ('00000000-0000-7000-8000-000000000204', 'Flow Param', 'FLOW-2-P1', '00000000-0000-7000-8000-000000000104', 'SECONDS',
     '00000000-0000-7000-8000-000000000004', 1500.0, 0.0, true, 'Primary flow reading'),

    -- Param for ADMIN
    ('00000000-0000-7000-8000-000000000205', 'Admin Flow Param', 'FLOW-Admin-P1', '00000000-0000-7000-8000-000000000103', 'METER',
