...
public class ReprocessService {
    ...
    public ReprocessService(SensorReadingRepository sensorReadingRepository, ReprocessChunkService chunkService) {
    ...
    public void checkAndReprocessHistoricalData(SensorConfig sensorConfig) {
        ...
        log.info("Outdated records found! Initiating iterative batch reprocessing for Sensor {}", sensorId);
        ...
        log.info("Successfully reprocessed {} historical records for Sensor {}", totalProcessed, sensorId);
    }
}