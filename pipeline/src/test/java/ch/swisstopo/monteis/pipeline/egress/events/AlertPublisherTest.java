...
class AlertPublisherTest {
    ...
    @Mock
    private KafkaTemplate<String, SensorBoundBreachedEvent> kafkaTemplate;
    ...
    void shouldHandlePublishingFailureGracefully() {
        ...
        CompletableFuture<SendResult<String, SensorBoundBreachedEvent>> failedFuture = new CompletableFuture<>();
