...
class RawSolExpertsSensorDataNormalizationServiceTest {
    ...
    @Mock
    private NormalizedSensorDataPublisher publisher;
    ...
    void shouldPublishMappedDataAndAcknowledgeOnSuccess() {
        ...
        RawSolExpertsSensorData payload = new RawSolExpertsSensorData(
                "deviceA", "2026-06-23T09:00:00Z", values
        );
        ...
        // then
        NormalizedSensorData expectedMainData = new NormalizedSensorData("deviceA", "2026-06-23T09:00:00Z", 15.5);
        then(publisher).should().publish("deviceA", expectedMainData);

        NormalizedSensorData expectedBatteryData = new NormalizedSensorData("deviceA_battery", "2026-06-23T09:00:00Z", 99.0);
    ...
    void shouldThrowExceptionAndNotAcknowledgeOnPublishFailure() {
        ...
        CompletableFuture<SendResult<String, NormalizedSensorData>> failedFuture = new CompletableFuture<>();
